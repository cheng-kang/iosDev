...
class TimerTestViewController: UIViewController {
    ...
    @IBAction func startBtnClick() {
        ...
        timerWillPause = PauseableTimer(timer: Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(TimerTestViewController.test), userInfo: nil, repeats: true))
    ...
    func expiredFiredateTest() {
        
        print("\(Date())")
        let t = Timer.scheduledTimer(withTimeInterval: 5, repeats: false, block: { timer in
            print("5")
            print("\(Date())")
        })
        ...
        Timer.scheduledTimer(withTimeInterval: 2, repeats: false, block: { timer in
            ...
            print("\(Date())")
            ti = t.fireDate
            t.fireDate = Date().addingTimeInterval(TimeInterval(100000))
            print(ti)
            print(t)
        })
    ...
    func testTimers() {
        ...
        Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(TimerTestViewController.timer1(timer:)), userInfo: nil, repeats: true)
